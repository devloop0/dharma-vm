...
int main(int argc, char* argv[]) {
	vector<string> vec;
	vec.push_back("func temp_0 bool_1");
	vec.push_back("mov r0 [bool_1]");
	vec.push_back("bneg r0");
	vec.push_back("jmp r0 .L0");
	vec.push_back("mov r2 [$1]");
	vec.push_back("ret r2");
	vec.push_back("mov r1 [$true]");
	vec.push_back("jmp r1 .L1");
	vec.push_back(".L0");
	vec.push_back(".L1");
	vec.push_back("mov r3 [$2]");
	vec.push_back("ret r3");
	vec.push_back("efunc");
	vec.push_back("mov r6 [$true]");
	vec.push_back("mov r5 [temp_0:r6]");
	vec.push_back("mov r7 [$' ']");
	vec.push_back("mov r9 [$false]");
	vec.push_back("mov r8 [temp_0:r9]");
	vec.push_back("mov r10 [$'\\n']");
	vec.push_back("mov r4 [print:r5,r7,r8,r10]");
